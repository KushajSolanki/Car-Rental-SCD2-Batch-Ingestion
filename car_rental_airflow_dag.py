...
PROJECT_ID = "analytical-park-467211-t1"
REGION = "us-central1"

pyspark_job_file_path = "gs://snowflake_project_test007/spark_job/spark_job.py"

# Define the Dataproc job config
PYSPARK_JOB = {
    ...
    "pyspark_job": {
        ...
        "jar_file_uris": [
            "gs://snowflake_project_test007/snowflake_jars/spark-snowflake_2.12-2.15.0-spark_3.4.jar",
            "gs://snowflake_project_test007/snowflake_jars/snowflake-jdbc-3.16.0.jar",
        ],
    },
}
