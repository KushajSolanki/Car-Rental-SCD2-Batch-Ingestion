...
def process_car_rental_data(data_date):
    ...
    gcs_file_path = f"gs://snowflake_project_test007/car_rental_data/car_rental_daily_data/car_rental_{data_date}.json"
    ...
    snowflake_options = {
        "sfURL": "https://wlhnzaz-xy52895.snowflakecomputing.com",
        "sfAccount": "wlhnzaz-xy52895",
        "sfUser": "Kushaj",
        "sfPassword": "Kushajsolanki@2004",
